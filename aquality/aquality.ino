...
const int NUM_NETWORKS = 4;  // número de redes Wi-Fi
const char* ssids[NUM_NETWORKS] = {"Aquality", "Qual a senha do wifi?", "Ana Soares", "Maciel"};
const char* passwords[NUM_NETWORKS] = {"12345678", "Farofa123", "jesusefielsim", "maciel777"};
...
void initWiFi() {
  ...
  for (int i = 0; i < NUM_NETWORKS; i++) {
    ...
    while (WiFi.status() != WL_CONNECTED && millis() - start < 30000){
      Serial.print(".");
      blinkLed(BLUE_LED, 3, 50, 50); // equivalent to delay(300)
    }
